...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='таблица доставки курьером' AUTO_INCREMENT=5 ;
...
(4, 'Гай Юлий Цезарь', '+890123123123123', 'veni@vidi.vici', 'veni', 'мутш', 'Veni', 1, 'Новая', '1324', '1', '2', '1', 'квартира 15', 'корпуссссс!!!!', '2 да удивлен!!!');
...
`id` int(11) NOT NULL COMMENT 'index',
  ...
  `text_latin` text COLLATE utf8_unicode_ci
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='таблица самовывоза' AUTO_INCREMENT=9 ;
...
(6, 'ФИО', '123', 'alexey.matveev1@rambler.ru1', 'Дополнительная информация', 'LOREM!!!', 'Vici', 1, 'undefined', ''),
(7, 'dd', 'ss', 'as@fsadfas.sd', 'fsdsdfdfsd', 'cffddfd', 'Vici', 1, '2', 'dd'),
(8, 'dd', 'ss', 'as@fsadfas.sd', 'fsdsdfdfsd', 'cffddfd', 'Vici', 1, '2', 'dd123');
...
--
ALTER TABLE `courier_delivery`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'index',AUTO_INCREMENT=5;
--
...
--
ALTER TABLE `self_delivery`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'index',AUTO_INCREMENT=9;
